...
const RestroCard = (props) => {
  ...
  return (
    <div>
      <img src={props.img} className="restro-img" alt="restro" />
      <h2>{props.name}</h2>
      <p>{props.time}</p>
      <p>{props.rating}</p>
      <p>{props.cuisine}</p>
    ...
    <div className="body">
      <div className="restro-list">
        <div className="restro-card">
          <RestroCard
            img="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/ixlexdhrxpu2ir9cc6xr"
            name="Namaste"
            time="25-30 mins"
            rating="4.5"
            cuisine="South Indian, Chinese, Thalis"
          />
        </div>
       <div className="restro-card">
          <RestroCard
